...
type CdkLambdaGo2StackProps struct {
	awscdk.StackProps
}

func NewCdkLambdaGo2Stack(scope constructs.Construct, id string, props *CdkLambdaGo2StackProps) awscdk.Stack {
...
func main() {
	...
	NewCdkLambdaGo2Stack(app, "CdkLambdaGo2Stack", &CdkLambdaGo2StackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
